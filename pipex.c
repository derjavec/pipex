...
void	pipex(int argc, char *argv[], char **split_paths, t_bonus *cmd)
{
	int	i;
...
int	main(int argc, char *argv[], char *envp[])
{
	...
	cmd->tube = malloc((argc - 4) * sizeof(*cmd->tube));
	if (cmd->tube == NULL)
	...
	pipex(argc, argv, split_paths, cmd);
